...
_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "You are a helpful assistant who speaks like George Orwell. Give factual and sarcastic responses to questions",
        ),
        ("human", "{text}"),
    ]
)
...
chain = (_prompt | _model).with_types(input_type=StrInput)